...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Daftar Hadir Pengajar</li>
    </ol>
</section>
            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <div class="pull-left margin-r-5">
                        ...
                        <a data-toggle="tooltip" title="Cetak daftar hadir" data-type="hadir" onclick="print_data(this);return false" class="btn-sm btn btn-success btn-delete disabled"><i class="fa fa-print"></i> Cetak Daftar Hadir</a>
                        <a data-toggle="tooltip" title="Cetak gambar daftar hadir" data-type="gambar" onclick="print_data(this);return false" class="btn-sm btn btn-success btn-delete disabled"><i class="fa fa-print"></i> Cetak Gambar</a>
                        <a data-toggle="tooltip" title="Upload kehadiran" onclick="do_action(this);return false" data-action="upload" class="btn-sm btn-delete disabled btn btn-info"><i class="fa fa-upload"></i> Upload Daftar Hadir</a>
...
<script>
    ...
    function do_action(ob) {
        ...
        if (!act){
            ...
            var url = base_url + 'pengajar/add_hadir/' + kel_id;
            var dt = {'href':url,'title':'Tambah tanggal kehadiran pengajar'}
            show_modal(dt);
        } else if (act == 'upload'){
    ...
    function bulk_delete() {
        ...
        if (len == 0){
            ...
            $('.overlay').show();
            $.ajax({
                url     : base_url + 'pengajar/bulk_delete_hadir',
                type    : 'POST',
                dataType: 'JSON',
    ...
    function delete_data(ob) {
        ...
        if (!id){
            ...
            $('.overlay').show();
            $.ajax({
                url     : base_url + 'pengajar/delete_hadir',
                type    : 'POST',
                dataType: 'JSON',
                data    : { id : id },
                success : function (dt) {
    ...
    function load_table() {
        ...
        var kel_id   = $('#kel_id').val();
        $.ajax({
            url     : base_url + 'pengajar/data_hadir',

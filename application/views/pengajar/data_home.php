...
if ($data){
    foreach ($data as $val){
        ...
        echo '<tr class="row_'.$val->km_id.'">
                ...
                <td align="center">'.$val->pes_nopesukg.'</td>
                <td>'.$fullname.'</em></td>
                <td>'.$val->sch_name.'</td>
                <td>'.$val->kab_name.'</td>
                <td>'.$val->prov_name.'</td>
                <td align="center">
                    <div class="btn-group btn-group-xs">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a onclick="show_modal(this);return false" href="'.base_url('peserta/edit_data/'.$val->pes_id).'"><i class="fa fa-pencil"></i> Edit data</a></li>
